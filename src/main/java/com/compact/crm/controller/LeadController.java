...
public class LeadController {
    ...
    public Page<Lead> getAllLeads(
        ...
        return leadService.getAllLeads(page, size, search, year, month);
    ...
    public Page<Lead> getDroppedLeads(
        ...
        return leadService.getLeadsByStatus(page, size, search, LeadStatus.DROPPED, year, month);
    ...
    public Page<Lead> getLostLeads(
        ...
        return leadService.getLeadsByStatus(page, size, search, LeadStatus.LOST, year, month);
    ...
    public Page<Lead> getUnresponsiveLeads(
        ...
        return leadService.getLeadsByStatus(page, size, search, LeadStatus.UNRESPONSIVE, year, month);
